...
when "suse"
  default[:neutron][:platform] = {
    ...
    :nec_agent_pkg => "openstack-neutron-nec-agent",
    :nec_agent_name => "openstack-neutron-nec-agent",
...
when "centos", "redhat"
  default[:neutron][:platform] = {
    ...
    :nec_agent_pkg => "openstack-neutron-nec",
    :nec_agent_name => "neutron-nec-agent",
    :lbaas_agent_pkg => "openstack-neutron-lbaas-agent",
  ...
  default[:neutron][:platform] = {
    ...
    :nec_agent_pkg => "neutron-plugin-nec-agent",
    :nec_agent_name => "neutron-plugin-nec-agent",
